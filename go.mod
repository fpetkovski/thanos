...
require (
	...
	github.com/thanos-community/promql-engine v0.0.0-20221201082410-f9757c8260ee
...
replace (
	...
	github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20221123154106-5dfa66120387
