...
replace (
	...
	// Using replace to avoid problems with peer deps
	github.com/thanos-io/promql-engine => github.com/thanos-io/promql-engine v0.0.0-20231030105626-dfb4b4f33539
