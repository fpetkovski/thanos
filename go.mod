...
replace (
	...
	github.com/prometheus/prometheus => github.com/fpetkovski/prometheus v1.8.2-0.20231227154311-b0914baeb38c
	github.com/thanos-io/promql-engine => github.com/fpetkovski/promql-engine v0.0.0-20231227154848-af75a9a407ba
