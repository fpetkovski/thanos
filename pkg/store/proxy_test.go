...
func sortedSeriesHint() *storepb.SeriesResponse {
	respHints := &hintspb.SeriesResponseHints{SeriesSorted: true}
...
func TestDedupRespHeap_Deduplication(t *testing.T) {
	...
	for _, tcase := range []struct {
		responses []*storepb.SeriesResponse
		testFn    func(responses []*storepb.SeriesResponse, h SeriesResponseIterable)
		tname     string
	}{
		{
