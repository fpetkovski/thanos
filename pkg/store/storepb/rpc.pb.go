...
type SeriesRequest struct {
	...
	// sort_without_labels are labels which are excluded
	// from comparison when sorting the response series set.
	SortWithoutLabels []string `protobuf:"bytes,14,rep,name=sort_without_labels,json=sortWithoutLabels,proto3" json:"sort_without_labels,omitempty"`
}
...
type QueryHints struct {
	...
	StartMillis int64 `protobuf:"varint,6,opt,name=start_millis,json=startMillis,proto3" json:"start_millis,omitempty"`
	// Query end time in milliseconds.
	EndMillis int64 `protobuf:"varint,7,opt,name=end_millis,json=endMillis,proto3" json:"end_millis,omitempty"`
	// The surrounding aggregation.
	AggrFunc *Func `protobuf:"bytes,2,opt,name=aggrFunc,proto3" json:"aggrFunc,omitempty"`
	// The surrounding time function.
	TimeFunc *Func `protobuf:"bytes,3,opt,name=timeFunc,proto3" json:"timeFunc,omitempty"`
...
var fileDescriptor_a938d55a388af629 = []byte{
	...
	,
}
...
func (m *SeriesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SortWithoutLabels) > 0 {
		for iNdEx := len(m.SortWithoutLabels) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SortWithoutLabels[iNdEx])
			copy(dAtA[i:], m.SortWithoutLabels[iNdEx])
			i = encodeVarintRpc(dAtA, i, uint64(len(m.SortWithoutLabels[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
...
func (m *QueryHints) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EndMillis != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.EndMillis))
		i--
		dAtA[i] = 0x38
	}
	if m.StartMillis != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.StartMillis))
		i--
		dAtA[i] = 0x30
	}
	if m.Range != nil {
	...
	if m.TimeFunc != nil {
		{
			size, err := m.TimeFunc.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AggrFunc != nil {
		{
			size, err := m.AggrFunc.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SeriesRequest) Size() (n int) {
	...
	if len(m.SortWithoutLabels) > 0 {
		for _, s := range m.SortWithoutLabels {
			l = len(s)
			n += 1 + l + sovRpc(uint64(l))
		}
	}
...
func (m *QueryHints) Size() (n int) {
	...
	if m.StartMillis != 0 {
		n += 1 + sovRpc(uint64(m.StartMillis))
	}
	if m.EndMillis != 0 {
		n += 1 + sovRpc(uint64(m.EndMillis))
	}
	return n
}
...
func (m *SeriesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SortWithoutLabels", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SortWithoutLabels = append(m.SortWithoutLabels, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
...
func (m *QueryHints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.AggrFunc.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimeFunc", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TimeFunc.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartMillis", wireType)
			}
			m.StartMillis = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartMillis |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndMillis", wireType)
			}
			m.EndMillis = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EndMillis |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
