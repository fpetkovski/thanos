...
func (o *overlapSplitSet) At() (prom_labels.Labels, []storepb.AggrChunk) {
...
func trimPushdownMarker(lbls labels.Labels) (labels.Labels, bool) {
	return labels.NewBuilder(lbls).Del(PushdownMarker.Name).Labels(labels.EmptyLabels()), lbls.Has(PushdownMarker.Name)
}
