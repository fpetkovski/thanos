...
import (
	...
	"github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/record"
	...
	"github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/wlog"
)
...
func TestMain(m *testing.M) {
	...
	goleak.VerifyTestMain(m, goleak.IgnoreTopFunction("github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb.(*SegmentWAL).cut.func1"), goleak.IgnoreTopFunction("github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb.(*SegmentWAL).cut.func2"))
}
